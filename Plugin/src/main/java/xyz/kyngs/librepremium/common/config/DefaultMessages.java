...
public class DefaultMessages {
    ...
    public static final CommentedConfigurationNode DEFAULT_MESSAGES;
    ...
    static {
        ...
        var helper = new ConfigurateHelper(DEFAULT_MESSAGES);

        helper.setDefault(KICK_PREMIUM_ERROR_THROTTLED);
        helper.setDefault(KICK_PREMIUM_ERROR_UNDEFINED);
        helper.setDefault(KICK_PREMIUM_INFO_ENABLED);
        helper.setDefault(KICK_PREMIUM_INFO_DISABLED);
        ...
        helper.setDefault(ERROR_NOT_AUTHORIZED);
        helper.setDefault(ERROR_NOT_REGISTERED);
        helper.setDefault(ERROR_NOT_PAID);
        helper.setDefault(ERROR_NOT_PREMIUM);
        ...
        helper.setDefault(ERROR_NO_CONFIRM);
        ...
        helper.setDefault(ERROR_UNKNOWN_COMMAND);

        helper.setDefault(INFO_LOGGING_IN);
        helper.setDefault(INFO_LOGGED_IN);
        helper.setDefault(INFO_REGISTERING);
        helper.setDefault(INFO_REGISTERED);
        helper.setDefault(INFO_ENABLING);
